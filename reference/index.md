...
- [`calculate_blinded_info()`](https://keaven.github.io/nbDesign/reference/calculate_blinded_info.md)
...
- [`sample_size_nbinom()`](https://keaven.github.io/nbDesign/reference/sample_size_nbinom.md)
