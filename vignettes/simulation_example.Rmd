...
We also display the 5-day event gap after each event where no new events can be recorded.

```{r, fig.width=7, fig.height=5, fig.alt="Patient timelines with events (dots), 5-day gaps (gray segments), and censoring (X)"}
